    ...
    <style>
        * {
        ...
        body {
            ...
            color: #000000;
            font-family: DejaVu Sans, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Arial, Helvetica, sans-serif;
            font-size: 11px;
            padding: 10px;
            margin: 0;
        }
        ...
        .col-prod { width: 150px; text-align: left; }
        .col-grade { width: 65px; text-align: center; }
