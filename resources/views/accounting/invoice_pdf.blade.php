    ...
    <div class="invoice-sheet">
        ...
        <table class="inv-table top-meta-row">
            <tr>
                ...
                <td style="width: 24%; text-align: center; font-size: 11px; font-weight: 800; padding-top: 3px;">
                    Form GST INV -1
                </td>
            ...
            <tr>
                ...
                <td style="width: 56%; padding: 0; vertical-align: top;">
                    <table class="inv-table">
                        <tr>
                            <td style="width: 52%; font-size: 10px; padding: 2.5px 5px;" class="border-r">
                                <strong>Invoice No.</strong> &nbsp;<strong>{{ $invoice->invoice_no ?: $invoice->id }}</strong>
                            </td>
                            <td style="width: 48%; font-size: 10px; padding: 2.5px 5px;">
                                <strong>Reverse Charge :</strong> No
                            </td>
                        </tr>
                        <tr class="border-t">
                            <td style="font-size: 10px; padding: 2.5px 5px;" class="border-r">
                                <strong>Invoice Dt.</strong> &nbsp;<strong>{{ date('d-m-Y', strtotime($invoice->invoice_date ?: date('Y-m-d'))) }}</strong>
                            </td>
                            <td style="font-size: 10px; padding: 2.5px 5px;">
                        ...
                        <tr class="border-t">
                            <td colspan="2" style="font-size: 10px; padding: 2.5px 5px;">
                ...
                <td style="width: 50%; padding: 0; vertical-align: top;" class="border-r">
                    ...
                    <div class="cust-details-box">
                        <table class="inv-table" style="width: 100%;">
                            <tr>
                                <td style="width: 55px; font-weight: 700; padding: 1px 0;">Name :</td>
                        ...
                        <table class="inv-table" style="width: 100%; margin-top: 2px;">
                            <tr>
